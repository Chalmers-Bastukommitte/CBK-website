...
const peopleData: Feature[] = [
  ...
  },
  {
    ...
    icon: (
      <img
      src="/images/people/storebror.jpg"/>
    ),
    title: 
      "Storebror",
    paragraph:""
